...
section .data
    archivo  db '/home/beto/Escritorio/ensamblador/Ensamblador/notas.txt',0
...
_start:
    leer text, 30
    ;*************acceder al archivo**************
    mov eax, 8 ;se convoca una subrutina de "escritura" al sistema operativo 
    mov ebx, archivo
    mov ecx, 1         ; modos de acceso
                        ; R-only = 0
                        ; W-only = 1
                        ;RDWR = 2
    mov edx, 0x1FF ;  para definir el permiso lo dejamos con "777"
    int 80h
