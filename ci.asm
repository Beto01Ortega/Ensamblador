...
section .data
        ...
        mensajeinv db 10, "Ingrese una opción válida no sea subnormal",10
        leninv equ $ - mensajeinv

        msj db 10,"Si desea continuar 1 = SI, 2 = No: ",10
        lenmsj equ $ - msj
section .bss
        n1 resb 1
        n2 resb 1
...
menu:
        ...
        ;Mensaje por si no ingresan una opción válida
        escribir mensajeinv, leninv
        jmp menu
